            ...
            completion(
                result.tryMap { versionMetadata in
                    PackageVersionMetadata(
                        ...
                        repositoryURLs: versionMetadata.metadata?.repositoryURLs?.compactMap { GitURL($0) },
...
public enum RegistryError: Error, CustomStringConvertible {
    ...
    case failedIdentityLookup(registry: Registry, scmURL: GitURL, error: Error)
...
extension RegistryClient {
    public struct PackageMetadata {
        ...
        public let alternateLocations: [GitURL]?
    }
