...
public struct Package {
    ...
    public let repositoryURLs: [GitURL]?
...
public struct PackageSearchClient {
    ...
    private func guessReadMeURL(baseURL: GitURL, defaultBranch: String) -> URL? {
    ...
    private func guessReadMeURL(alternateLocations: [GitURL]?) -> URL? {
    ...
    public func lookupSCMURLs(
        ...
        observabilityScope: ObservabilityScope,
        callbackQueue: DispatchQueue,
        completion: @escaping (Result<Set<GitURL>, Error>) -> Void
    ) {
