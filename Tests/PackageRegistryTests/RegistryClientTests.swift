...
final class RegistryClientTests: XCTestCase {
    func testGetPackageMetadata() throws {
        ...
        XCTAssertEqual(metadata.alternateLocations!, [
            GitURL("https://github.com/mona/LinkedList"),
            GitURL("ssh://git@github.com:mona/LinkedList.git"),
            GitURL("git@github.com:mona/LinkedList.git"),
            GitURL("https://gitlab.com/mona/LinkedList"),
        ])
    }
    ...
    func testDownloadSourceArchive() throws {
        ...
        let repositoryURLs = [
            GitURL("https://github.com/\(identity.scope)/\(identity.name)"),
            GitURL("ssh://git@github.com:\(identity.scope)/\(identity.name).git"),
            GitURL("git@github.com:\(identity.scope)/\(identity.name).git"),
        ]
    ...
    func testDownloadSourceArchive_checksumNotInStorage() throws {
        ...
        XCTAssertEqual(GitURL(registryURL), fingerprint.origin.url)
    ...
    func testLookupIdentities() throws {
        let registryURL = URL("https://packages.example.com")
        let packageURL = GitURL("https://example.com/mona/LinkedList")
...
extension RegistryClient {
    ...
    fileprivate func lookupIdentities(scmURL: GitURL) throws -> Set<PackageIdentity> {
        try temp_await {
